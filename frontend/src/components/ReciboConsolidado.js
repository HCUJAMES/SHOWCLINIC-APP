...
export default function ReciboConsolidado({ open, onClose, datos }) {
  const handlePrint = () => {
    window.print();
  };
  ...
  return (
    ...
    >
      <DialogContent sx={{ p: 0 }}>
        {/* Contenido del ticket consolidado */}
        <Box
          id="ticket-consolidado"
          sx={{
            p: 2,
        ...
        >
          ...
          <Box sx={{ mb: 1.5 }}>
            ...
            {tratamientos.map((trat, idx) => (
              <Box key={idx} sx={{ mb: 1.5, pb: 1, borderBottom: idx < tratamientos.length - 1 ? "1px dashed rgba(0,0,0,0.2)" : "none" }}>
                <Typography
                  sx={{
                    fontSize: "0.75rem",
                    fontWeight: 600,
                ...
                >
                  {idx + 1}. {trat.nombre || "Tratamiento"}
                </Typography>
                <Box sx={{ pl: 1 }}>
                  <Box sx={{ display: "flex", justifyContent: "space-between", fontSize: "0.7rem", mb: 0.2 }}>
                    <Typography sx={{ fontSize: "0.7rem", color: "rgba(0,0,0,0.7)" }}>
                      Especialista:
                    </Typography>
                  ...
                  <Box sx={{ display: "flex", justifyContent: "space-between", fontSize: "0.7rem", mt: 0.3 }}>
